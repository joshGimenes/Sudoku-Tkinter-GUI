...
def printBoard(board):
    ...
    for i,line in enumerate(board):
        ...
        boardString = boardString + (
                str(line[0][0] if line[0][1] else ' ') +
                str(line[1][0] if line[1][1] else ' ') +
                str(line[2][0] if line[2][1] else ' ') +
                str(line[3][0] if line[3][1] else ' ') +
                str(line[4][0] if line[4][1] else ' ') +
                str(line[5][0] if line[5][1] else ' ') +
                str(line[6][0] if line[6][1] else ' ') +
                str(line[7][0] if line[7][1] else ' ') +
                str(line[8][0] if line[8][1] else ' '))
        if (i == 8):
        #print(boardString)
            pass
